...
Before running the applications, make sure to configure the .env files for both projects. 

### Laravel .env

For the Laravel application, you must set the RECIPIENT_WHATSAPP_NUMBER variable, which is the phone number that will receive the message. The variables WHATSAPP_API_INSTANCE and WHATSAPP_API_KEY will be updated later, after we create an instance in the Evolution API.
...
![image](https://github.com/user-attachments/assets/ea21248e-68e4-41ed-88d1-eafd63ad2440)
...
![image](https://github.com/user-attachments/assets/a0844b11-d6b7-44cd-97e3-a60bc5696a3f)
...
![image](https://github.com/user-attachments/assets/dc8b39ec-d131-4042-84fa-c0543cb1eb5d)
...
![image](https://github.com/user-attachments/assets/f8c4abea-08f2-4617-9b31-53b95a29f8ed)
...
![image](https://github.com/user-attachments/assets/147f8bfc-99c7-4a9a-bfaf-813f4153c73a)
